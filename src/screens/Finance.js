          ...
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            <div className='row'>
              <div className='col-md-6 mb-3'>
                ...
                >
                  <option>Select</option>
                  <option value='Bada Dost i1'>Dost i1</option>
                  <option value='Bada Dost i2'>Dost i2</option>
                  <option value='Bada Dost i3'>Dost i3</option>
                  <option value='Bada Dost i3+'>Dost i3+</option>
                  <option value='Bada Dost i4'>Dost i4</option>
