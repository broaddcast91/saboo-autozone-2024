...
function Dosti2() {
  return (
    <>
      <Helmet>
        <title>
          Ashok Leyland Bada Dost i2 On Road Price in Hyderabad | Saboo AutoZone
        </title>
        <meta
          name='title'
          content='Ashok Leyland Bada Dost i2 On Road Price in Hyderabad | Saboo AutoZone'
        />
        <meta
          name='description'
        ...
        <meta
          ...
          content="Ashok Leyland Bada Dost i2 Small Commercial Vehicle will be available in two variants -i3 and i4.  Bada Dost 'i3 LS' is priced at INR 8.75 lakhs &  Bada Dost i4 priced at 8.52 lakh.  For more info about Bada Dost features & specifications call us 91002 55555."
        />
        <meta
          property='og:image'
  ...
  return (
    <>
      <img
        ...
        src={require('../../src/img/bada-dost-i2-banner.webp')}
        alt='dost-banner'
      />
      ...
      <div className='mb-2 row'>
        <div className='mb-3 overflow-hidden col-lg-6'>
          <img
            ...
            src={require('../img/vehicles/i2-thumb-2.webp')}
            alt='Bada-Dost-i2'
          />
        </div>
        <div className='mb-3 col-lg-6 ps-4'>
          ...
          <div>
            ...
            <a
              href='https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/autozone/Bada-Dost-i2-brochure.pdf'
              target='_blank'
...
const Specsi2 = () => {
  return (
    <>
      <h4>Ashok Leyland Bada Dost i2 BS6 Specifications and Features</h4>
      <div className='row'>
    ...
    >
      <div className='p-3 row align-items-center'>
        <div className='mt-3 col-lg-6 col-md-12 col-12'>
          <h3>Get On Road Price of Bada Dost i2</h3>
          <small>
        ...
        <div className='mt-3 overflow-hidden col-lg-6 col-md-12 col-12 pe-0'>
          <img
            ...
            src={require('../img/vehicles/i2-thumb-1.webp')}
