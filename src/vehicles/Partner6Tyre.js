...
function Partner6Tyre() {
  return (
    <>
      <Helmet>
        <title>
        Ashok Leyland Partner 6-Tyre Price in Hyderabad | Best Summer Offers 2025 | Mileage & Specifications
        </title>
        <meta
          name="title"
          content="Ashok Leyland Partner 6-Tyre Price in Hyderabad | Best Summer Offers 2025 | Mileage & Specifications"
        />
        <meta
          name="description"
          content="Ashok Leyland Partner 6-Tyre Truck on-road price in Hyderabad starts from the best summer 2025 offers. Explore mileage, technical specifications, features, and exclusive deals at Saboo AutoZone showrooms. Call 91002 55555 today!"
        />
        <meta
          name="keywords"
